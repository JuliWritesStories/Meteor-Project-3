// JSON data URL
let queryUrl = "../static/cleaned_data.json";
//let queryUrl = "{{url_for('static', filename='cleaned_data.json')}}";
...
d3.json(queryUrl).then(function (data) {
    ...
    for (i = 0; i < data.length; i++) {
        let feature = {
            ...
            "geometry": {
                "type": "Point",
                "coordinates": [data[i].reclong, data[i].reclat]
            }
        }
